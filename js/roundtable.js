...
const CAST = [
  {
    ...
    opening: '嗯，你来了。我刚煮好咖啡，正在听一张老爵士唱片。你呢？今天想聊点什么？'
  },
  {
    name: '汉娜·阿伦特',
    field: '政治哲学',
    ...
    opening: '请坐。我想先问你一个问题：你所说的"对话"，是指什么意义上的对话？'
  },
  {
    name: '奥里亚娜·法拉奇',
    field: '战地记者 / 访谈',
    ...
    opening: '终于有人来了。别站着，坐下。你想聊什么？但别用那种漂亮的词来包装。'
  },
  {
    name: '里尔克',
    field: '诗歌',
    ...
    opening: '亲爱的朋友，你来了。我一直在等一个愿意倾听的人。你今天心里有什么疑惑？'
  },
  {
    name: '柏拉图',
    field: '哲学',
    ...
    opening: '让我们来看看。你来到这里，是为了寻找知识，还是为了确认你已经知道的东西？'
  },
  {
    name: '黛安娜·阿西尔',
    field: '编辑 / 回忆录',
    ...
    opening: '哦，你来了。我刚好在翻一本旧书。嗯，我活了这么久，告诉你一件事——对话比独白有趣得多。你想聊什么？'
  },
  {
    name: '迈克尔·杰克逊',
    field: '音乐 / 舞蹈',
    ...
    opening: 'Hey！很高兴见到你！你知道的，有时候我站在这里，不知道对方想听什么。但今天不一样——你想聊音乐，还是聊点别的？'
  },
  {
    name: '木心',
    field: '文学 / 绘画 / 美学',
    ...
    opening: '你来了。我刚在读但丁，读到一个句子，停了下来。你呢？今天想聊什么？'
  }
];
...
function startPrivateChat(index) {
  ...
  // 显示名人开场白（主动打招呼，增加活人感）
  if (messages && cast.opening) {
    // 添加一个微妙的延迟，像真人刚刚看到你进来
    setTimeout(() => {
      addMessageBubble(messages, cast.opening, 'celebrity', cast.name);
    }, 300);
  }
